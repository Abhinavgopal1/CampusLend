...
export const MOCK_USERS: MockUser[] = [
  ...
  },
  {
    id: "u10",
    name: "Ishita Bansal",
    email: "ishita.b@bmu.edu.in",
    avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Ishita",
    college: "BML Munjal University",
...
export const MOCK_ITEMS: MockItem[] = [
  {
    ...
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Priya",
    ownerRating: 4.9,
    ownerVerified: true,
  ...
  },
  {
    ...
    deposit: 8000,
    condition: "good",
    location: "Main Library, Locker 42",
    availability: "available",
    ownerId: "u1",
    ownerName: "Arjun Mehta",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Arjun",
    ownerRating: 4.8,
    ownerVerified: true,
  ...
  },
  {
    ...
    deposit: 200,
    condition: "good",
    location: "Academic Block 2, Near Canteen",
    availability: "available",
    ownerId: "u8",
    ownerName: "Meera Iyer",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Meera",
    ownerRating: 4.9,
    ownerVerified: true,
  ...
  },
  {
    ...
    deposit: 1000,
    condition: "good",
    location: "Sports Complex, Equipment Room",
    availability: "available",
    ownerId: "u3",
    ownerName: "Rahul Gupta",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Rahul",
    ownerRating: 4.5,
    ownerVerified: true,
  ...
  },
  {
    ...
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Ananya",
    ownerRating: 4.7,
    ownerVerified: true,
  ...
  },
  {
    ...
    description:
      "Compact 45-liter mini fridge, perfect for hostel rooms. Energy efficient, quiet operation. Includes small freezer compartment. Clean and well-maintained.",
    images: [
    ...
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Sneha",
    ownerRating: 4.6,
    ownerVerified: true,
  ...
  },
  {
    ...
    deposit: 3000,
    condition: "good",
    location: "Parking Lot B, Slot 23",
    availability: "available",
    ownerId: "u7",
    ownerName: "Karan Chopra",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Karan",
    ownerRating: 4.4,
    ownerVerified: true,
  ...
  },
  {
    ...
    deposit: 6000,
    condition: "like-new",
    location: "Hostel Block A, Room 118",
    availability: "available",
    ownerId: "u10",
    ownerName: "Ishita Bansal",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Ishita",
    ownerRating: 4.7,
    ownerVerified: true,
  ...
  },
  {
    ...
    deposit: 4000,
    condition: "good",
    location: "Student Activity Center, Room 3",
    availability: "available",
    ownerId: "u1",
    ownerName: "Arjun Mehta",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Arjun",
  ...
  },
  {
    ...
    description:
      "Coleman Breckenridge sleeping bag. Rated for 0°C. Lightweight and compact. Perfect for treks, overnight trips, or when your hostel room gets too cold!",
    images: [
    ...
    deposit: 500,
    condition: "good",
    location: "Hostel Block B, Room 410",
    availability: "available",
    ownerId: "u5",
    ownerName: "Vikram Singh",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Vikram",
    ownerRating: 4.3,
    ownerVerified: false,
  ...
  },
  {
    ...
    deposit: 500,
    condition: "good",
    location: "Academic Block 1, Locker 15",
    availability: "available",
    ownerId: "u8",
    ownerName: "Meera Iyer",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Meera",
  ...
  },
  {
    ...
    deposit: 2000,
    condition: "good",
    location: "Cycle Stand C, Near Gate 3",
    availability: "available",
    ownerId: "u3",
    ownerName: "Rahul Gupta",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Rahul",
  ...
  },
  {
    ...
    description:
      "JBL Flip 6 portable Bluetooth speaker. IP67 waterproof. 12-hour battery life. PartyBoost enabled. Amazing sound quality for hostel parties and outdoor events.",
    images: [
    ...
    deposit: 1500,
    condition: "like-new",
    location: "Hostel Block A, Room 320",
    availability: "available",
    ownerId: "u6",
    ownerName: "Sneha Reddy",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Sneha",
  ...
  },
  {
    ...
    availability: "available",
    ownerId: "u9",
    ownerName: "Aditya Joshi",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Aditya",
    ownerRating: 4.2,
    ownerVerified: false,
  ...
  },
  {
    ...
    deposit: 700,
    condition: "good",
    location: "Sports Complex, TT Room",
    availability: "available",
    ownerId: "u7",
    ownerName: "Karan Chopra",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Karan",
  ...
  },
  {
    ...
    description:
      "Combo: 1.5L electric kettle with temperature control + pour-over coffee maker with filters. Essential for hostel life. Makes perfect chai and coffee!",
    images: [
    ...
    deposit: 400,
    condition: "good",
    location: "Hostel Block B, Room 215",
    availability: "available",
    ownerId: "u10",
    ownerName: "Ishita Bansal",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Ishita",
  ...
  },
  {
    ...
    deposit: 800,
    condition: "good",
    location: "Lab Building, Locker 7",
    availability: "available",
    ownerId: "u1",
    ownerName: "Arjun Mehta",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Arjun",
  ...
  },
  {
    ...
    deposit: 3000,
    condition: "like-new",
    location: "Hostel Block C, Room 412",
    availability: "available",
    ownerId: "u4",
    ownerName: "Ananya Patel",
    ownerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Ananya",
...
export const MOCK_REVIEWS: MockReview[] = [
  {
    ...
    reviewerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Arjun",
    rating: 5,
    communication: 5,
    itemCondition: 5,
    timeliness: 5,
    comment:
      "Priya's MacBook was in excellent condition. Super responsive to messages and flexible with pickup timing. Highly recommend!",
    date: "2026-08-15",
    itemTitle: "MacBook Pro 14\" M3",
  },
  {
    ...
    reviewerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Rahul",
    rating: 4,
    communication: 4,
    itemCondition: 4,
    timeliness: 5,
  ...
  },
  {
    ...
    reviewerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Ananya",
    rating: 5,
    communication: 5,
    itemCondition: 5,
    timeliness: 4,
    comment:
      "Meera's book set was a lifesaver during exam prep. Clear highlights and the solutions manual was super helpful. Thank you!",
    date: "2026-08-12",
  ...
  },
  {
    ...
    reviewerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Sneha",
    rating: 4.5,
    communication: 5,
    itemCondition: 4,
    timeliness: 5,
    comment:
      "The formal suit fit perfectly for my placement interview. Clean and well-maintained. Ananya was super helpful with sizing advice!",
    date: "2026-08-08",
    itemTitle: "Formal Suit (Navy Blue, Size 40)",
  },
  {
    id: "rev5",
    reviewerName: "Karan Chopra",
    reviewerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Karan",
    rating: 4,
    communication: 3,
    itemCondition: 5,
    timeliness: 4,
  ...
  },
  {
    ...
    reviewerAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Ishita",
    rating: 5,
    communication: 5,
    itemCondition: 5,
    timeliness: 5,
    comment:
      "Arjun's projector was amazing for our movie night in the hostel. Setup was easy and picture quality was brilliant. 10/10!",
    date: "2026-08-06",
...
export const MOCK_MESSAGES: MockMessage[] = [
  {
    ...
    senderAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Priya",
    lastMessage: "Sure! You can pick it up from my room after 5 PM today.",
  ...
  },
  {
    ...
    senderAvatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Ananya",
...
// ----------------------------------------------------------
export const CURRENT_USER = MOCK_USERS[0]; // Arjun Mehta
